                  ...
                  <form action="/admin/obat" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        ...
                        @enderror" id="name" name="name" placeholder="Nama Obat" value="{{ old('name', $obat->name) }}" />
                        @error('name')
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        ...
                        @enderror" id="price" name="price" placeholder="price" value="{{ old('price', $obat->price) }}"/>
                        @error('price')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        ...
                        @enderror" id="stock" name="stock" placeholder="stock" value="{{ old('stock', $obat->stock) }}"/>
                        @error('stock')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <textarea id="deaskripsi" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi" value="{{ old('description', $obat->description) }}"></textarea>
                        @error('description')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
